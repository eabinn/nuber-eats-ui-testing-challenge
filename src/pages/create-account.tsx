...
import { CreateAccountMutation, CreateAccountMutationVariables } from "../__type_graphql__/CreateAccountMutation";
    ...
    <div className="h-screen flex justify-center items-center bg-gray-50">
      ...
      <div className="bg-white shadow-2xl rounded-lg w-full max-w-lg mx-5 py-10">
        ...
        <form onSubmit={handleSubmit(_submit)} className="w-full flex flex-col px-6">
          ...
          <select ref={register} name="role" className="border-b-2 border-blue-400 py-2 bg-transparent focus:outline-none">
          ...
          <Button className="mt-12" canClick={formState.isValid} loading={loading} actionText="Create Account" />
