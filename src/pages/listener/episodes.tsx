...
import { getEpisodes, getEpisodesVariables, getEpisodes_getPodcast_podcast } from "../../__type_graphql__/getEpisodes";
    ...
    <div className="w-full px-5 xl:px-0 mx-auto max-w-screen-xl">
      ...
      <div className="flex justify-center my-8">
        <div className="flex flex-col justify-center px-3 md:px-12 w-3/4">
          <h1 className="text-blue-400 font-semibold text-3xl">{data?.getPodcast.podcast?.title}</h1>
          <h2 className="py-3 text-md font-light">{data?.getPodcast.podcast?.description}</h2>
          <Link
            to="/"
